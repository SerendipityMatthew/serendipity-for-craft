...
export class DocumentDataService {
  ...
  private createInitialData() {
    const id0 = createRandomId()
    const id1 = createRandomId()
    const id2 = createRandomId()
    const id3 = createRandomId()
    const id4 = createRandomId()
    const id5 = createRandomId()
    const id6 = createRandomId()
    const id7 = createRandomId()
    const id8 = createRandomId()
    const id9 = createRandomId()
    const id10 = createRandomId()
    ...
    this.subblocks.set(this.rootId, [id0, id1, id2, id3, id4, id5, id6, id7, id8, id9, id10 ])
  }
